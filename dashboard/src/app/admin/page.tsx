...
const DEMO_CLINICS: ClinicProfile[] = [
  {
    ...
    targets: { followUpRate: 4.0, hepRate: 95, utilisationRate: 75, dnaRate: 6, treatmentCompletionTarget: 80 },
    brandConfig: {},
  ...
  },
  {
    ...
    featureFlags: { intelligence: true, continuity: true, receptionist: false },
    targets: { followUpRate: 2.5, hepRate: 90, utilisationRate: 80, dnaRate: 5, treatmentCompletionTarget: 80 },
    brandConfig: {},
  ...
  },
  {
    ...
    trialStartedAt: null,
    featureFlags: { intelligence: true, continuity: true, receptionist: false },
    targets: { followUpRate: 3.0, hepRate: 92, utilisationRate: 80, dnaRate: 5, treatmentCompletionTarget: 80 },
    brandConfig: {},
    onboarding: { pmsConnected: true, cliniciansConfirmed: true, targetsSet: true },
  ...
  },
  {
    ...
    trialStartedAt: null,
    featureFlags: { intelligence: true, continuity: true, receptionist: false },
    targets: { followUpRate: 2.8, hepRate: 90, utilisationRate: 85, dnaRate: 5, treatmentCompletionTarget: 80 },
    brandConfig: {},
    onboarding: { pmsConnected: true, cliniciansConfirmed: true, targetsSet: true },
