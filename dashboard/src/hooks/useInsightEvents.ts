...
const DEMO_INSIGHT_EVENTS: InsightEvent[] = [
  ...
  },
  {
    ...
    clinicianId: "c-james",
    severity: "positive",
    title: "James hit 92% treatment completion this week — highest in 6 weeks",
    description: "11 out of 12 discharged patients completed their full treatment this week. This is James's best treatment completion rate in the last 6 weeks.",
  ...
  },
  {
    ...
    metadata: { patientName: "James Whitfield", clinicianName: "Alex Pemberton", daysSinceLastVisit: 12, sessionsCompleted: 3, treatmentLength: 6 },
  },
  {
    id: "demo-evt-5",
