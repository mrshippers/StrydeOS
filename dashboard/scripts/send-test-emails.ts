...
const emails = [
  ...
  },
  {
    ...
    html: buildStateOfClinicEmail({
      ...
      currentStats: { followUpRate: 4.1, dnaRate: 0.058, utilisationRate: 0.79, treatmentCompletionRate: 0.74 },
      previousStats: { followUpRate: 3.8, dnaRate: 0.072, utilisationRate: 0.76, treatmentCompletionRate: 0.71 },
    }),
