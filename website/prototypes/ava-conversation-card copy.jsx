    ...
    <>
      ...
      <div className="ava-s" style={{
        ...
        >
          ...
          {/* Layer 1: Top catch-light — bright highlight fading down */}
          <div style={{
          ...
          {/* Layer 2: Full diagonal sheen — PS5 disc tray gloss */}
          <div style={{
          ...
          {/* Layer 3: Radial light source — top-left, like overhead studio lighting */}
          <div style={{
          ...
          {/* Layer 6: Inner border highlight — creates depth perception */}
          <div style={{
