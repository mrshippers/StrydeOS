      ...
      <header style={{
        ...
        <div style={{
          ...
          <a href="/" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none" }}>
            <svg width="28" height="28" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="StrydeOS">
              <defs>
                ...
                <clipPath id="cs-ca"><polygon points="35,52 57,40 57,20 35,20"/></clipPath>
              </defs>
              ...
              <rect x="35" y="20" width="22" height="60" rx="5" fill="url(#cs-gt)" clipPath="url(#cs-ca)"/>
